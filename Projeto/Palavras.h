...
int word_input(char [16][16], char, int, char, char [1][16],int *, int *, int, int, int );
...
void final_print_board(char [16][16], char *, int );
void file_letter_reader(char *, int, char *);

/* Função do algoritmo das jogadas */

void algoritmo(char [16][16], char*, char*, int*, int, char [0][16], char **[16], int [16], int, int *, int );
